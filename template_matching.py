...
class TemplateMatchingHelper:
    ...
    def validate_containment_with_template_matching(
        ...
        try:
            ...
            if mag_ratio < 1.5:
                return False, {"error": "Insufficient magnification difference"}
            ...
            if score > threshold:
                ...
                match_result = {
                    ...
                    "width": w,
                    "height": h,
                    "low_img_shape": low_img.shape,  # Save original image shape for debugging
                    "high_img_shape": high_img.shape  # Save original image shape for debugging
                }
